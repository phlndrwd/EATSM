...
${OBJECTDIR}/src/Data/DataTag.o: src/Data/DataTag.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Isrc/Input/ -Isrc/Model/ -Isrc/Output/ -Isrc/Tools/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Data/DataTag.o src/Data/DataTag.cpp
...
${OBJECTDIR}/src/Data/Tagger.o: src/Data/Tagger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Data
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Isrc/Input/ -Isrc/Model/ -Isrc/Output/ -Isrc/Tools/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Data/Tagger.o src/Data/Tagger.cpp
...
${OBJECTDIR}/src/Input/InitialState.o: src/Input/InitialState.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Isrc/Input/ -Isrc/Model/ -Isrc/Output/ -Isrc/Tools/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input/InitialState.o src/Input/InitialState.cpp
...
${OBJECTDIR}/src/Model/Autotrophs.o: src/Model/Autotrophs.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Isrc/Input/ -Isrc/Model/ -Isrc/Output/ -Isrc/Tools/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Model/Autotrophs.o src/Model/Autotrophs.cpp
...
${OBJECTDIR}/src/Model/Time.o: src/Model/Time.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Isrc/Input/ -Isrc/Model/ -Isrc/Output/ -Isrc/Tools/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Model/Time.o src/Model/Time.cpp
