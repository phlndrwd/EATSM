...
HeterotrophsParallel::HeterotrophsParallel( ) {
}

HeterotrophsParallel::HeterotrophsParallel( Types::NutrientPointer nutrient, Types::AutotrophsPointer autotrophs ) {
    mNutrient = nutrient;
...
void HeterotrophsParallel::CreateInitialPopulation( ) {
...
void HeterotrophsParallel::ResetIndividualMatrix( ) {
...
void HeterotrophsParallel::Update( ) {
    Feeding( );
    Metabolisation( );
    Reproduction( );
    Starvation( );
...
bool HeterotrophsParallel::RecordData( ) {
...
unsigned HeterotrophsParallel::GetSizeClassPopulation( const unsigned sizeClassIndex ) const {
    return mLivingMatrix[ sizeClassIndex ].size( );
}

Types::IndividualPointer HeterotrophsParallel::GetIndividual( const unsigned sizeClassIndex, const unsigned individualIndex ) const {
    return mLivingMatrix[ sizeClassIndex ][ individualIndex ];
}

void HeterotrophsParallel::CalculateFeedingProbabilities( ) {
...
void HeterotrophsParallel::Feeding( ) {
...
void HeterotrophsParallel::Metabolisation( ) {
    for( unsigned index = 0; index < mLivingVector.size( ); ++index ) {
        Types::IndividualPointer individual = mLivingVector[ index ];
...
void HeterotrophsParallel::Reproduction( ) {
    for( unsigned index = 0; index < mLivingVector.size( ); ++index ) {
...
void HeterotrophsParallel::Starvation( ) {
    ResetIndividualMatrix( );
...
void HeterotrophsParallel::FeedFromAutotrophs( const Types::IndividualPointer grazer ) {
...
void HeterotrophsParallel::FeedFromHeterotrophs( const Types::IndividualPointer predator, unsigned coupledIndex ) {
...
Types::IndividualPointer HeterotrophsParallel::GetRandomIndividualFromSizeClass( const unsigned sizeClassIndex, const Types::IndividualPointer individual ) const {
...
void HeterotrophsParallel::DeleteDead( ) {
...
void HeterotrophsParallel::DeleteIndividual( Types::IndividualPointer individual ) {
...
void HeterotrophsParallel::StarveToDeath( Types::IndividualPointer individual ) {
...
void HeterotrophsParallel::KillIndividual( Types::IndividualPointer individual ) {
    individual->Kill( );
    mSizeClassDeadFrequencies[ individual->GetSizeClassIndex( ) ] += 1;
    mDeadVector.push_back( individual );
}

void HeterotrophsParallel::AddChildren( ) {
